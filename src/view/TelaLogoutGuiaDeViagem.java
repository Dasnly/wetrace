 ...
 * @author Victor
 */
public class TelaLogoutGuiaDeViagem extends javax.swing.JFrame {

    /**
     * Creates new form TelaLogout
     */
    public TelaLogoutGuiaDeViagem() {
        initComponents();
    }
    ...
    private void NaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NaoActionPerformed
         setVisible(false);
         TelaGuiaDeViagem telaGuia = new TelaGuiaDeViagem();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLogoutGuiaDeViagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaLogoutGuiaDeViagem().setVisible(true);
            }
        });
    }
