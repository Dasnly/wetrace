 ...
 * @author Victor
 */
public class TelaLogoutViajante extends javax.swing.JFrame {

    /**
     * Creates new form TelaLogout
     */
    public TelaLogoutViajante() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLogoutViajante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaLogoutViajante().setVisible(true);
            }
        });
    }
